...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_rightboard(
        ...
        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_Y,           KC_B,           KC_N,           KC_M,           RALT_T(KC_COMM),RCTL_T(KC_DOT), RSFT_T(KC_SLSH), 
    ...
    [1] = LAYOUT_rightboard(
        ...
        KC_F10,         KC_F1,          KC_F2,          KC_F3,          KC_BRK,         KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO, 
    ...
    [2] = LAYOUT_rightboard(
        ...
        S(KC_GRV),      S(KC_1),        S(KC_2),        S(KC_3),        S(KC_BSLS),      KC_NO,         KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO, 
    ...
    [4] = LAYOUT_rightboard(
        ...
        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_NO,                                          KC_PSCR,        MS_LEFT,        MS_DOWN,        MS_RGHT,        KC_NO, 
        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          C(KC_Z),        C(KC_X),        C(KC_C),        C(KC_V),        C(KC_Y), 
    ...
    [5] = LAYOUT_rightboard(
        ...
        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_NO,                                          KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RGHT,        KC_INS, 
        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          C(KC_Z),        C(KC_X),        C(KC_C),        C(KC_V),        C(KC_Y), 
                                        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS),
    [6] = LAYOUT_rightboard(
...
// put encoder map "reversed"
#if defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD),  ENCODER_CCW_CW(KC_RGHT, KC_LEFT)  },
    [1] = { ENCODER_CCW_CW(KC_NO, KC_NO),  ENCODER_CCW_CW(KC_RGHT, KC_LEFT)  },
    [2] = { ENCODER_CCW_CW(KC_NO, KC_NO),  ENCODER_CCW_CW(KC_RGHT, KC_LEFT)  },
    [3] = { ENCODER_CCW_CW(KC_NO, KC_NO),  ENCODER_CCW_CW(KC_RGHT, KC_LEFT)  },
    [4] = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD),  ENCODER_CCW_CW(KC_NO, KC_NO)  },
    [5] = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD),  ENCODER_CCW_CW(KC_NO, KC_NO)  },
    [6] = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD),  ENCODER_CCW_CW(KC_NO, KC_NO)  },
};
#endif
